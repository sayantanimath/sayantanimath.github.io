...
\item\adjustbox{valign=t}{\begin{tikzpicture}[xscale=0.4,yscale=0.6] 
...
\item\adjustbox{valign=t}{\begin{tikzpicture}[scale=5,cap=round,>=latex]
...
\item\adjustbox{valign=t}{\begin{tikzpicture}[xscale=0.55,yscale=0.7]
    \begin{scope}
...
\item\adjustbox{valign=t}{\begin{tikzpicture}[scale=0.7] 
...
\item\adjustbox{valign=t}{\begin{tikzpicture}[auto,node distance=1.5cm]
...
\item\adjustbox{valign=t}{\begin{tikzpicture}[sibling distance=10em,
...
\begin{enumerate}
    \item\adjustbox{valign=t}{\begin{tikzpicture}[thick]
\draw (0,0) grid (3,3);
...
\item\adjustbox{valign=t}{\begin{tikzpicture}[scale=.5]
